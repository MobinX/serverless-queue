...
import { pgQueueMessages, type PgQueueTable } from './schema.ts'

export class DrizzlePgStorage extends MessageStorage {
  constructor(
    private readonly db: {
      select: (...args: any[]) => any
      insert: (...args: any[]) => any
    ...
    private readonly table: PgQueueTable = pgQueueMessages,
  ) {
    super()
  }
